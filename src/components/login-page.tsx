...
export function LoginPage({ storeName = "Private Pricing OS" }: LoginPageProps) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4 bg-slate-50 relative overflow-hidden">
            {/* Ambient Background Elements - more subtle for light theme */}
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent className="space-y-6 relative pb-8">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between ml-1">
                                    ...
                                    <button type="button" className="text-xs text-blue-600 hover:text-blue-700 font-semibold transition-colors">Forgot password?</button>
                                </div>
                                <Input
                                    id="password"
                                    type="password"
                        ...
                        <CardFooter className="flex flex-col gap-4 pb-10">
                            ...
                            <p className="text-center text-slate-400 text-xs font-medium">
                                Secured by Private Pricing OS Enterprise Security
                            </p>
                        </CardFooter>
                    </form>
                </Card>
